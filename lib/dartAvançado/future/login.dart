...
class _LoginState extends State<Login> {
  ...
  //sempre que trabalhar com tarefas assincronas no flutte ruse initState
  @override
  void initState(){
    super.initState();
  }
  ...
  bool sucesso = await autenticar("admin", "admin1");
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 40,),
            ElevatedButton(onPressed: _carregando ? null : _fazerLogin  , child: Text("simular login ") )
          ],
        ),
      ),
    );
