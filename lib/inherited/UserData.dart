...
class UserData extends InheritedWidget{
  ...
  const UserData({
    ...
    /* 
      este método estatico pode ser chamado independente de termos instanciando o objeto ou não.
      definimos um método estatico chamado of
      isso significa que você pode chamar UserData.of(context) sem precisar de uma instancia de UserData
